...
class ClientModel(Model):
    ...
    def create_model(self):
        """Model function for convnet model."""
        pass
    ...
    def process_x(self, raw_x_batch):
        ...
        # ).to(self.device)
        return torch.stack(raw_x_batch).to(self.device)
...
class ResNetModel(torch.nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.resnet = model = torch.hub.load('pytorch/vision:v0.10.0', 'resnet18', pretrained=True)
